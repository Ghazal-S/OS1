...
_getppidTest:     file format elf32-i386
...
int main(void) {
  ...
  11:	83 ec 08             	sub    $0x8,%esp
    int parent = getpid();
  14:	e8 39 03 00 00       	call   352 <getpid>
  19:	89 c6                	mov    %eax,%esi
    int child = fork();
  1b:	e8 aa 02 00 00       	call   2ca <fork>
    if(child == 0) {
  20:	85 c0                	test   %eax,%eax
  22:	75 27                	jne    4b <main+0x4b>
        printf(1, "child: parent=%d child=%d getpid()=%d getppid()=%d\n",
  24:	e8 31 03 00 00       	call   35a <getppid>
  29:	89 c3                	mov    %eax,%ebx
  2b:	e8 22 03 00 00       	call   352 <getpid>
  30:	51                   	push   %ecx
  31:	51                   	push   %ecx
  32:	53                   	push   %ebx
  33:	50                   	push   %eax
  34:	6a 00                	push   $0x0
  36:	56                   	push   %esi
  37:	68 78 07 00 00       	push   $0x778
  3c:	6a 01                	push   $0x1
  3e:	e8 dd 03 00 00       	call   420 <printf>
  43:	83 c4 20             	add    $0x20,%esp
    ...
    exit();
  46:	e8 87 02 00 00       	call   2d2 <exit>
  4b:	89 c3                	mov    %eax,%ebx
        wait();
  4d:	e8 88 02 00 00       	call   2da <wait>
        printf(1, "parent: parent=%d child=%d getpid()=%d getppid()=%d\n",
  52:	e8 03 03 00 00       	call   35a <getppid>
  57:	89 c7                	mov    %eax,%edi
  59:	e8 f4 02 00 00       	call   352 <getpid>
  5e:	52                   	push   %edx
  5f:	52                   	push   %edx
  60:	57                   	push   %edi
  61:	50                   	push   %eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb e4 07 00 00       	mov    $0x7e4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 9c 0a 00 00    	cmp    %eax,0xa9c
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 747:	0a 00 00 
 74a:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
 759:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 760:	00 00 00 
